...
public:
  ...
  DPGLOGIT(List X_list0, List Y_list0, arma::uvec Z_prior, double psi_par,  double H, double H_upper,  double alpha, double a_prior, double tau_prior, arma::vec b_prior, arma::mat Q_prior, int n_iter0);
...
//=========== CONSTRUCTOR =============//
DPGLOGIT::DPGLOGIT(List X_list0, List Y_list0, arma::uvec Z_prior,double psi_par, double H, double H_upper, double alpha, double a_prior, double tau_prior, arma::vec b_prior, arma::mat Q_prior, int n_iter0) : prior(H, H_upper, alpha, X_list0.size())
{
  // Number of datastes
  n = X_list0.size();
  // Base partition
...
void DPGLOGIT::updatePolyaVars(int iter)
{
 for(int j = 0; j < n; ++j)
 {
...
//---------------------------------//
void DPGLOGIT::updateIntercept(int iter)
{
 for(int j = 0; j < n; ++j)
 {
...
//------------------------------------//
void DPGLOGIT::updateBeta(int iter)
{
...
//-----------------------------------------------------------/
void DPGLOGIT::updateClass(int iter)
{
...
//-----------------------------------------------------------/
void DPGLOGIT::splitMerge(int iter)
{
