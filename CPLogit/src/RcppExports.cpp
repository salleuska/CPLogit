...
List gibbsLogitCPMultiple(List X_list0, List Y_list0, arma::umat Z_prior, double psi_par, double H, double H_upper, double alpha, double a_prior, double tau_prior, arma::vec b_prior, arma::mat Q_prior, int n_iter0);
RcppExport SEXP _CPLogit_gibbsLogitCPMultiple(SEXP X_list0SEXP, SEXP Y_list0SEXP, SEXP Z_priorSEXP, SEXP psi_parSEXP, SEXP HSEXP, SEXP H_upperSEXP, SEXP alphaSEXP, SEXP a_priorSEXP, SEXP tau_priorSEXP, SEXP b_priorSEXP, SEXP Q_priorSEXP, SEXP n_iter0SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type X_list0(X_list0SEXP);
    Rcpp::traits::input_parameter< List >::type Y_list0(Y_list0SEXP);
    Rcpp::traits::input_parameter< arma::umat >::type Z_prior(Z_priorSEXP);
    Rcpp::traits::input_parameter< double >::type psi_par(psi_parSEXP);
    Rcpp::traits::input_parameter< double >::type H(HSEXP);
    Rcpp::traits::input_parameter< double >::type H_upper(H_upperSEXP);
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    ...
    Rcpp::traits::input_parameter< arma::mat >::type Q_prior(Q_priorSEXP);
    Rcpp::traits::input_parameter< int >::type n_iter0(n_iter0SEXP);
    rcpp_result_gen = Rcpp::wrap(gibbsLogitCPMultiple(X_list0, Y_list0, Z_prior, psi_par, H, H_upper, alpha, a_prior, tau_prior, b_prior, Q_prior, n_iter0));
    return rcpp_result_gen;
END_RCPP
}
// gibbsLogit
